...
» :gem:  Hoşgeldin  ${member}

» :gem:  Seninle birlikte ${üyesayısı} kişiyiz.

» :gem:  [ ★ ] Tagımızı alarak ekibimize katılabilirsin.

» :gem:  <@&1020613671086465044>  Of Priv seninle ilgilenecektir.

» :gem:  Bu Kullanıcı Güvenli :white_check_mark: 

» :gem:  Hesabın Oluşturulma Tarihi: 

» :gem:  ses teyit odasında kaydınızı yaptırabilirsiniz
