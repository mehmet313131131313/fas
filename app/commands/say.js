...
» :gem:   Şu anda toplam **${ses-bot || "0"}** (**+${bot || "0"} bot**) kişi seslide.
» :gem:   Sunucuda **${üyesayısı}** adet üye var (**${aktif || "0"}** Aktif)
» :gem:   Toplamda **${tag || "0"}** kişi tagımızı alarak bizi desteklemiş.
» :gem:   Toplamda **${booster}** adet boost basılmış! ve Sunucu **${boostLevel}** seviye `))
